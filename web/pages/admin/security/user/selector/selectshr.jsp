...
$(function() {
	...
	tree.on('click', function(node) {
		document.getElementById('users').src="${ctx}/userselector/index1.do?deptId=" + node.id + "&authoritys=${param.authoritys}";
	});
	tree.render();
	/* tree.expandAll(); */
});
...
<table width="606" cellpadding="0" cellspacing="0" style="border: 1px solid #D9D9D9; border-right: 0px; ">
  <tr>
    ...
    <iframe name="users" width="100%" height="408" src="${ctx}/userselector/index1.do?authoritys=${param.authoritys}" frameborder="0" scrolling="no" id="users"></iframe>
    </td>
  </tr>
</table>
<script type="text/javascript">
