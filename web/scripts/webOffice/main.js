...
function addMark(obj) {
	...
	document.all.WebOffice1.SetFieldValue("type", option, "::ADDMARK::");
}
function addSeal(obj,path){
	var option = obj.value;
	document.all.WebOffice1.SetFieldValue("seal", "", "::ADDMARK::");
	if(option != "" && option != null){
		document.all.WebOffice1.SetFieldValue("seal", path+option, "::JPG::");
	}
}
function addFrontCover(obj,path){
	var option = obj.value;
	document.all.WebOffice1.SetFieldValue("frontCover", "", "::ADDMARK::");
	if(option != "" && option != null){
		document.all.WebOffice1.SetFieldValue("frontCover", path+option, "::FILE::");
	}
}
/*******************************************************************************
 * 
...
function SaveDoc(path) {
	...
	try {
		...
		// 添加相应的Post元素
		webObj.HttpAddPostString("fileName", document.getElementById("fileName").value);
		webObj.HttpAddPostCurrFile("DocContent", ""); // 上传文件
		returnValue = webObj.HttpPost(path + "/scripts/webOffice/savedoc.jsp"); // 判断上传是否成功
