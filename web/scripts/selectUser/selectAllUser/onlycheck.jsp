...
$(function() {
	...
	tree = new Ext.tree.ColumnTree({
		...
		loader : new Ext.tree.ColumnTreeLoader({
			dataUrl : '/systop/dept/deptTreeSeleectAllRadio.do',
			uiProviders : {
	...
	tree.on('click', function(node) {
		document.getElementById('users').src="${ctx}/userselector/onlyRadiocheckAll.do?deptId=" + node.id + "&authoritys=${param.authoritys}";
	});
	tree.render();
	tree.expandAll();
});
